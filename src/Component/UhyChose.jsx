    ...
    return (
        ...
        <div className=' container mx-auto px-4 py-15'>
            <div className='grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6'>
                <div className=' bg-[#F2695C]/5 rounded-xl h-[320px] p-7 hover:bg-[#F2695C] transition duration-500 cursor-pointer ease-in-out'>
                   <div className='bg-white inline-block p-2 rounded-2xl shadow-md'>
                    ...
                    <h2 className='text-xl font-bold text-black/80 py-5'>30+ Years of Local Property Experience</h2>
                     <p className='text-[15px] font-semibold text-black/50'> We are not loud, noisy and full of our own self-importance. As your agent we know we work for you.</p>
                </div>
                <div className=' bg-[#F2695C]/5 rounded-xl h-[320px] p-7 hover:bg-[#F2695C] transition duration-500 cursor-pointer ease-in-out'>
                   <div className='bg-white inline-block p-2 rounded-2xl shadow-md'>
                    ...
                    Happy Clients</h2>
                     <p className='text-[15px] font-semibold text-black/50'>Not all agents have the skills or experience to ensure you get the highest price for your property. Our experience is your guarantee of best price.</p>
                </div>
               <div className=' bg-[#F2695C]/5 rounded-xl h-[320px] p-7 hover:bg-[#F2695C] transition duration-500 cursor-pointer ease-in-out'>
                   <div className='bg-white inline-block p-2 rounded-2xl shadow-md'>
                ...
                <div className=' bg-[#F2695C]/5 rounded-xl h-[320px] p-7 hover:bg-[#F2695C] transition duration-500 cursor-pointer ease-in-out'>
                   <div className='bg-white inline-block p-2 rounded-2xl shadow-md'>
                    ...
                    <p className='text-[15px] font-semibold text-black/50'> that integrate multiple tools seamlessly to provide personalized and highly efficient help</p>
                </div>
            </div>
        </div>
        </div>
