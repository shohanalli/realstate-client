  ...
  return (
    <div className="py-15 w-[95%] mx-auto">
      <div className="flex  items-center justify-center">
        ...
        <h1 className="font-bold text-2xl text-center mt-5">Oops, page not found!</h1>
        <p className="text-base text-center mb-5">The page you are looking for is not available.</p>
